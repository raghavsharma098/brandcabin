...
export default function About() {
  ...
  const stats = [
    ...
    { number: "10+", label: "HMobiley Clients", icon: <Heart className="w-6 h-6" /> },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-28 lg:pb-24 overflow-hidden min-h-[70vh] sm:min-h-[75vh] lg:min-h-[80vh] flex items-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-purple-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"></div>
          
          {/* Floating elements */}
          <div className="floating-element absolute top-20 left-10 w-64 h-64 bg-gradient-to-br from-blue-300/20 to-purple-300/20 dark:from-blue-600/20 dark:to-purple-600/20 rounded-full mix-blend-multiply filter blur-3xl opacity-60"></div>
          <div className="floating-element absolute top-40 right-10 w-72 h-72 bg-gradient-to-br from-purple-300/20 to-blue-300/20 dark:from-purple-600/20 dark:to-blue-600/20 rounded-full mix-blend-multiply filter blur-3xl opacity-60"></div>
          <div className="floating-element absolute bottom-32 left-1/3 w-80 h-80 bg-gradient-to-br from-blue-400/15 to-purple-400/15 dark:from-blue-500/20 dark:to-purple-500/20 rounded-full mix-blend-multiply filter blur-3xl opacity-50"></div>
          
          {/* Geometric shapes */}
          <div className="absolute top-32 right-1/4 w-4 h-4 bg-blue-400 dark:bg-blue-500 rounded-full opacity-40 animate-pulse"></div>
          <div className="absolute top-48 left-1/4 w-3 h-3 bg-purple-400 dark:bg-purple-500 rounded-full opacity-40 animate-pulse delay-1000"></div>
          <div className="absolute bottom-40 right-1/3 w-5 h-5 bg-blue-500 dark:bg-blue-400 rounded-full opacity-30 animate-pulse delay-2000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div ref={heroRef} className="max-w-5xl mx-auto text-center">
            ...
            <div className="mb-8 sm:mb-10 lg:mb-12 max-w-4xl mx-auto">
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 leading-relaxed font-light">
                We&apos;re a creative digital agency specializing in innovative web solutions, stunning designs, and powerful Mobilelications that drive business growth.
              </p>
              
              {/* Key highlights */}
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-8 text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400 mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
              ...
              <Link 
                href="/contact"
                className="group relative border-2 border-blue-200 dark:border-blue-600 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-blue-700 dark:text-blue-300 px-6 py-3 sm:px-8 sm:py-4 lg:px-10 lg:py-5 rounded-2xl font-semibold hover:bg-blue-50 dark:hover:bg-gray-700 hover:border-blue-300 dark:hover:border-blue-500 transition-all duration-300 inline-flex items-center gap-3 hover:scale-105 w-full sm:w-auto justify-center"
              >
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-gray-900 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-900/30 via-transparent to-purple-900/30"></div>
          <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-br from-blue-800/20 to-purple-800/20 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-br from-purple-800/20 to-blue-800/20 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div ref={missionRef} className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12 sm:mb-16 lg:mb-20">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-900/30 to-purple-900/30 text-blue-300 px-4 py-2 sm:px-6 sm:py-3 rounded-full text-sm font-medium mb-6 shadow-lg border border-blue-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-6 sm:space-y-8">
                {/* Mission Card */}
                <div className="group relative bg-gradient-to-br from-gray-800 to-gray-700 p-6 sm:p-8 rounded-3xl border border-gray-600 hover:border-gray-500 transition-all duration-500 hover:shadow-xl hover:shadow-blue-500/10 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-xl sm:text-2xl font-bold text-white group-hover:text-blue-400 transition-colors duration-300">Our Mission</h3>
                ...
                {/* Vision Card */}
                <div className="group relative bg-gradient-to-br from-gray-800 to-gray-700 p-6 sm:p-8 rounded-3xl border border-gray-600 hover:border-gray-500 transition-all duration-500 hover:shadow-xl hover:shadow-purple-500/10 hover:scale-105">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className="text-xl sm:text-2xl font-bold text-white group-hover:text-purple-400 transition-colors duration-300">Our Vision</h3>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-20">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
                {[
                  ...
                  <div key={index} className="group text-center p-4 sm:p-6 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl border border-gray-600 hover:border-gray-500 hover:shadow-lg transition-all duration-300 hover:scale-105">
                    <div className="text-blue-400 mb-2 sm:mb-3 flex justify-center group-hover:scale-110 transition-transform duration-300">
                      {stat.icon}
                    </div>
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                      {stat.number}
                    </div>
      ...
      {/* Values Section */}
      <section className="py-20 sm:py-24 bg-gradient-to-br from-gray-900 to-gray-800 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div ref={valuesRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {values.map((value) => (
              <div key={value.title} className="value-card group bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-700 hover:border-gray-600 relative overflow-hidden">
          ...
          <div ref={statsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {stats.map((stat) => (
              <div key={stat.label} className="stat-item text-center group">
                <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-3xl p-8 hover:shadow-xl transition-all duration-500 border border-gray-600 hover:border-gray-500 group-hover:scale-105">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {whyChooseUs.map((reason) => (
              <div key={reason.title} className="group bg-gray-800 rounded-3xl p-8 hover:shadow-xl transition-all duration-500 border border-gray-700 hover:border-gray-600 hover:scale-105">
      ...
      <section className="py-20 sm:py-24 bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Our <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Technologies</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
            {technologies.map((tech) => (
              <div key={tech.name} className="group">
                <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-600 hover:border-gray-500 aspect-square flex flex-col items-center justify-center group-hover:scale-110">
                  <Image 
                    src={tech.logo} 
                    alt={tech.name}
                    width={48}
                  ...
                  />
                  <span className="text-sm font-medium text-gray-200 text-center group-hover:text-blue-400 transition-colors duration-300">
                    {tech.name}
                  </span>
                </div>
              </div>
