      ...
      <div className={`space-y-6 sm:space-y-8 text-center lg:text-left ${className}`}>
        <div className="space-y-4 sm:space-y-6">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
            ...
            <span className="block">With The Brand Cabin</span>
          </h1>
  ...
  return (
    <div className={`space-y-6 sm:space-y-8 animate-fade-in-up text-center lg:text-left ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center lg:justify-start">
        ...
        <button className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-xl overflow-hidden transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-lg w-full sm:w-auto">
