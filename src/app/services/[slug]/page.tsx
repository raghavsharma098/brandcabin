...
const servicesData = {
  'web-development': {
    ...
    longDescription: 'Our web development services encompass the entire development lifecycle, from initial concept and design to deployment and maintenance. We specialize in building modern, responsive, and scalable web Mobilelications that deliver exceptional user experiences across all devices.',
    icon: Code,
    image: '/tech_logos/react.jpeg',
    features: [
      'Custom Web Mobilelications',
      'Progressive Web Mobiles (PWAs)', 
      'API Development & Integration',
      'Database Design & Optimization',
      'E-commerce Solutions',
      'Content Management Systems',
      'Real-time Mobilelications',
    ...
    testimonials: [
      {
        name: 'Sarah Johnson',
        role: 'CEO, TechStart',
        content: 'The web Mobilelication they built exceeded our expectations. The performance and user experience are outstanding.',
  ...
  'Mobile-Mobile-development': {
    ...
    longDescription: 'Our Mobile Mobile development expertise covers both native and cross-platform solutions. We create intuitive, high-performance Mobile Mobilelications that provide seamless user experiences across iOS and Android platforms.',
    icon: Smartphone,
    image: '/tech_logos/Flutter.png',
    features: [
      'Cross-Platform Development',
      'Native iOS & Android Mobiles',
    ...
    projects: [
      {
        ...
        description: 'Comprehensive fitness Mobile with workout tracking, nutrition planning, and social features',
    ...
    process: [
      {
        step: '01',
        title: 'Mobile Strategy & Planning',
    ...
    testimonials: [
      {
        ...
        content: 'Our Mobile Mobile has over 100k downloads thanks to their excellent development and UX design.',
        avatar: '/tech_logos/Flutter.png'
      },
      {
        name: 'David Rodriguez',
        role: 'Product Manager, FoodCorp',
        content: 'They delivered a robust food delivery Mobile that handles thousands of orders daily without issues.',
  ...
  'ui-ux-design': {
    ...
    projects: [
      {
        id: 1,
        title: 'Banking Mobile Redesign',
        description: 'Complete redesign of Mobile banking Mobile improving user engagement by 40%',
        image: '/tech_logos/react.jpeg',
    ...
    testimonials: [
      {
        ...
        content: 'Their design thinking Mobileroach transformed our user experience. Conversion rates increased by 60%.',
        avatar: '/tech_logos/react.jpeg'
      },
      {
        name: 'James Park',
  ...
  'cloud-solutions': {
    ...
    projects: [
      {
        ...
        description: 'Migrated large enterprise Mobilelication to AWS with 99.9% uptime and 40% cost reduction',
        image: '/tech_logos/AWS.jpg',
      ...
      {
        id: 3,
        title: 'Serverless Mobilelication',
        description: 'Built scalable serverless Mobilelication architecture reducing infrastructure costs by 60%',
        image: '/tech_logos/Google Cloud.jpeg',
    ...
    process: [
      ...
      },
      {
        ...
        description: 'Phased migration planning with minimal downtime Mobileroach',
        icon: Database
      },
      {
        step: '04',
    ...
    testimonials: [
      {
        name: 'Steven Roberts',
        role: 'CTO, ScaleTech',
        content: 'The cloud migration was seamless and our Mobilelication performance improved dramatically. Costs reduced by 50%.',
  ...
  'api-development': {
    ...
    longDescription: 'Our API development services focus on creating robust, scalable, and secure backend solutions that form the backbone of modern Mobilelications. We build RESTful and GraphQL APIs with comprehensive documentation and testing.',
    icon: Code,
    ...
    process: [
      ...
      },
      {
        ...
        description: 'Optimized database structure and relationship mMobileing',
        icon: Database
      },
      {
        step: '03',
  ...
  'shopify-development': {
    ...
    longDescription: 'Our Shopify development services provide end-to-end e-commerce solutions, from custom theme development to complex Mobile integrations. We create high-converting Shopify stores that deliver exceptional shopping experiences.',
    icon: ShoppingCart,
    image: '/tech_logos/next.png',
    features: [
      'Custom Shopify Theme Development',
      'Shopify Mobile Development',
      'Payment Gateway Integration',
    ...
    projects: [
      {
        ...
        image: '/tech_logos/next.png',
        technologies: ['Shopify Plus', 'Custom Theme', 'Mobile Integration'],
        link: '/portfolio?filter=E-commerce'
      },
      {
        id: 2,
        ...
        image: '/tech_logos/react.jpeg',
        technologies: ['Shopify', 'Custom Mobile', 'Payment Processing'],
        link: '/portfolio?filter=E-commerce'
      },
      {
        id: 3,
        ...
        image: '/tech_logos/Node.jpeg',
        technologies: ['Shopify', 'Subscription Mobile', 'Webhooks'],
        link: '/portfolio?filter=E-commerce'
      }
    ],
    process: [
          ...
          <div ref={featuresRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
            {service.features.slice(0, 6).map((feature: string, idx: number) => {
              ...
              const descriptions = [
                ...
                'Native-quality Mobilelications optimized for performance across all major platforms and devices.',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto text-center mb-16 sm:mb-20 lg:mb-24">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              A systematic Mobileroach to deliver exceptional {service.title.toLowerCase()} results, from initial consultation to ongoing support.
            </p>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <div ref={processRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 sm:gap-6 lg:gap-4">
              {service.process.map((step: any, idx: number) => { // eslint-disable-line @typescript-eslint/no-explicit-any
                ...
                return (
                  <div key={idx} className="text-center group animate-step-Mobileear" style={{ animationDelay: delays[idx] || '0.5s' }}>
