...
const services = [
  {
    ...
    description: 'We create powerful, scalable web Mobilelications using cutting-edge technologies like React, Next.js, and Node.js. From concept to deployment, we handle everything.',
    slug: 'web-development',
    icon: Code,
    image: '/tech_logos/react.jpeg',
    features: ['Custom Web Mobilelications', 'Progressive Web Mobiles', 'API Development', 'Database Design'],
  ...
  },
  {
    ...
    description: 'Native-quality Mobile Mobiles for iOS and Android using React Native and Flutter. Reach your audience wherever they are with seamless user experiences.',
    slug: 'Mobile-Mobile-development',
    icon: Smartphone,
    image: '/tech_logos/Flutter.png',
    features: ['Cross-Platform Mobiles', 'Native Performance', 'Mobile Store Optimization', 'Push Notifications'],
  ...
  },
  {
    ...
    icon: ShoppingCart,
    image: '/tech_logos/next.png',
    features: ['Custom Shopify Themes', 'Mobile Development', 'Payment Integration', 'Store Optimization'],
  ...
  },
  {
    ...
    description: 'Robust RESTful and GraphQL APIs that power your Mobilelications. Secure, scalable, and well-documented backend solutions for any platform.',
  ...
  return (
    <div className="min-h-screen bg-gray-900 overflow-hidden">
      ...
      <section className="relative pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 opacity-60" />
        
        {/* Animated background blobs */}
        <div className="absolute inset-0 overflow-hidden">
          <div ref={el => { heroBgBlobsRef.current[0] = el }} className="absolute top-20 left-10 w-64 h-64 bg-blue-800/30 rounded-full mix-blend-multiply filter blur-2xl opacity-20"></div>
          <div ref={el => { heroBgBlobsRef.current[1] = el }} className="absolute top-40 right-10 w-72 h-72 bg-purple-800/30 rounded-full mix-blend-multiply filter blur-2xl opacity-20"></div>
          <div ref={el => { heroBgBlobsRef.current[2] = el }} className="absolute bottom-20 left-1/3 w-80 h-80 bg-pink-800/30 rounded-full mix-blend-multiply filter blur-2xl opacity-15"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-5xl mx-auto text-center mb-8 sm:mb-12 lg:mb-16">
            <h1 ref={heroTitleRef} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-8 leading-tight">
              What We <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Offer</span>
            </h1>
            <p ref={heroDescRef} className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto mb-8 sm:mb-10 lg:mb-12">
              <div ref={el => { categoryCardsRef.current[0] = el }} className="group bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105">
                ...
                <h3 className="font-bold text-white text-sm sm:text-base mb-1">Development</h3>
                <p className="text-xs sm:text-sm text-gray-300">Web & Mobile Mobiles</p>
              </div>
              
              <div ref={el => { categoryCardsRef.current[1] = el }} className="group bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105">
                ...
                <h3 className="font-bold text-white text-sm sm:text-base mb-1">Design</h3>
                <p className="text-xs sm:text-sm text-gray-300">UI/UX & Branding</p>
              </div>
              
              <div ref={el => { categoryCardsRef.current[2] = el }} className="group bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105">
                ...
                <h3 className="font-bold text-white text-sm sm:text-base mb-1">Infrastructure</h3>
                <p className="text-xs sm:text-sm text-gray-300">Cloud & DevOps</p>
              </div>
              
              <div ref={el => { categoryCardsRef.current[3] = el }} className="group bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105">
                ...
                <h3 className="font-bold text-white text-sm sm:text-base mb-1">Marketing</h3>
                <p className="text-xs sm:text-sm text-gray-300">SEO & Analytics</p>
              </div>
            </div>
      ...
      {/* Services Section */}
      <section className="relative py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-800 to-gray-900">
            ...
            {services.map((service, idx) => {
              ...
              return (
                <div
                  ...
                  className={`group relative bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-700 hover:border-gray-600 overflow-hidden ${
                    hoveredCard === idx ? 'z-10' : ''
                  }`}
                >
                  {/* Card Background Gradient */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${service.bgGradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500`} />
                  ...
                  <div className="relative p-6 sm:p-8">
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="text-right">
                        <div className="text-xs font-medium text-gray-400 uppercase tracking-wide">{service.category}</div>
                    ...
                    {/* Service Title */}
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-gray-200 transition-colors">
                      {service.title}
                    </h3>
                    <p className="text-sm font-medium text-gray-400 mb-4">{service.subtitle}</p>
                    ...
                    {/* Tech Stack */}
                    <div className="mb-6">
                      <div className="text-xs font-medium text-gray-400 uppercase tracking-wide mb-3">Technologies</div>
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        {service.technologies.length > 3 && (
                          <div className="text-xs text-gray-400">+{service.technologies.length - 3}</div>
                        )}
                      </div>
                      <div className="flex flex-wrap gap-1">
                        {service.technologies.slice(0, 4).map((tech) => (
                          <span
                            key={tech}
                            className="px-2 py-1 rounded-full text-xs font-medium bg-gray-700 text-gray-200"
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="text-center p-3 bg-gray-700 rounded-xl">
                        ...
                        <div className="font-bold text-white">{service.category}</div>
                      </div>
                      <div className="text-center p-3 bg-gray-700 rounded-xl">
                        <div className="text-xs text-gray-400 mb-1">Timeline</div>
                        <div className="font-bold text-white">{service.timeline}</div>
                      </div>
                    </div>
      ...
      {/* CTA Section */}
      <section className="relative py-16 sm:py-20 md:py-24 bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-64 h-64 bg-blue-800/30 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-purple-800/30 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse delay-1000"></div>
        </div>
        
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div ref={ctaRef} className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <Sparkles className="w-16 h-16 mx-auto text-blue-400 mb-6" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="border-2 border-gray-600 text-gray-300 px-8 py-4 rounded-2xl font-medium hover:bg-gray-700 hover:border-gray-500 transition-all duration-300 flex items-center gap-2">
