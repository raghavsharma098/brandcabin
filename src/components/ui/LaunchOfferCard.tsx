...
export default function LaunchOfferCard() {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-3xl p-6 sm:p-8 border-2 border-dashed border-blue-300 dark:border-blue-600 mb-8">
      {/* Floating elements */}
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="flex items-center gap-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-4 rounded-xl">
            <Users className="w-8 h-8 text-blue-600 dark:text-blue-400" />
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 dark:text-white">Free 1-on-1 Consultation</h4>
          ...
          <div className="flex items-center gap-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-4 rounded-xl">
            ...
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 dark:text-white">1 Month Free Maintenance</h4>
          ...
          <div className="flex items-center gap-3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-4 rounded-xl">
            ...
            <div className="text-left">
              <h4 className="font-semibold text-gray-900 dark:text-white">Unlimited Design Revisions</h4>
